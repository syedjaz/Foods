...
$fetch_cat = "SELECT * FROM books JOIN categories ON books.cate_id = categories.cat_id ";
...
<a href="add_books.php"><i data-cs-icon="plus"></i>
<span>Add Books</span>
</a>
</button>
...
<?php
    ...
    <div class="card mb-2">
        ...
        <div class="col-12 col-lg-1 d-flex flex-column pe-1 mb-2 mb-lg-0 justify-content-center order-4">
        <img src="media/<?php echo $data['b_image']?>" alt="" width="60" height="60" style="border:1px ridge black">
        </div>
        ...
        <div class="lh-1 text-alternate">
            <a href="bookedit.php?bookid=<?php echo $data['b_id']?>"> Edit </a>| <a href="book_del.php?bookid=<?php echo $data['b_id']?>">Delete</a> </div>
        </div>
