...
<!-- Mirrored from acorn-html-ecommerce-platform.coloredstrategies.com/Customers.List.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Aug 2021 05:40:18 GMT -->
<head>
<meta charset="UTF-8">
...
<div class="col-12 col-lg-3 d-flex align-items-center mb-2 mb-lg-0 text-muted text-small">ID</div>
<div class="col-6 col-lg-3 d-flex align-items-center text-alternate text-medium text-muted text-small">NAME</div>
<div class="col-6 col-lg-3 d-flex align-items-center text-alternate text-medium text-muted text-small">LOCATION</div>
<div class="col-6 col-lg-3 d-flex align-items-center text-alternate text-medium text-muted text-small">CONTACT</div>
</div>
</div>
</div>
</div>
...
$res = mysqli_query($con,$fetch_customer);
...
<a href="Customers.Detail.html" class="text-truncate h-100 d-flex align-items-center"><?php echo $data['c_id']?></a>
</div>
...
<div class="text-alternate"><?php echo $data['c_name']?></div>
</div>
...
<div class="text-alternate"><?php echo $data['c_address']?></div>
</div>

<div class="col-6 col-lg-3 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-5 order-lg-4">
<div class="text-muted text-small d-lg-none">Contact</div>
...
<script src="js/cs/checkall.js"></script><script src="js/pages/customers.list.js"></script>
<script src="js/common.js"></script>
<script src="js/scripts.js"></script>
</body>

<!-- Mirrored from acorn-html-ecommerce-platform.coloredstrategies.com/Customers.List.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Aug 2021 05:40:19 GMT -->
</html>
