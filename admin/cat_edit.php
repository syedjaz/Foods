...
if(isset($_POST['updatecat'])){
    ...
    $update = "UPDATE categories SET cat_name = '{$cat}' WHERE cat_id = '{$id}'";
    $res = mysqli_query($con,$update);
  echo "<script>window.location.href='http://localhost:82/ebook/admin/view_category.php'</script>";
 }
$read_cat = "SELECT * FROM categories WHERE cat_id = '{$id}'";
$res = mysqli_query($con,$read_cat);
...
<span class="text-small align-middle">Update Category</span>
</a>
<h1 class="mb-0 pb-0 display-4" id="title">Category Details</h1>
</div>
</div>
...
<input type="text" class="form-control" name="catname" value="<?php echo $data['cat_name']?>">
</div>
<?php
...
?>
<input type="submit" name="updatecat" value="Update Category" class="btn btn-primary btn-outline-light">
