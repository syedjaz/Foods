...
require "config.php";
  if(isset($_POST['register'])){
     ...
     if(isset($_FILES['image'])){
        $errors = array();
        $filename = rand(0,10).$_FILES['image']['name'];
        ...
        move_uploaded_file($tmpname,'media/'.$filename);
            ...
            echo "<script>window.location.href='http://localhost:82/ebook/admin/register.php'</script>";
            die();
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Register as an Admin</h5>
                  ...
                  <form class="row g-3 needs-validation" novalidate method='POST' enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                      <label for="yourUsername" class="form-label">Userprofile</label>
                      <div class="input-group has-validation">
                       
                        <input type="file" name="image" class="form-control" id="yourUserprofile" required>
