...
if(isset($_POST['addcat'])){
    ...
    $insert_sql = "INSERT INTO categories(cat_id,cat_name,cat_status) VALUES( '{$catid}','{$catname}','{$status}')";
...
<input type="text" name="catid" class="form-control" value="<?php function generatePIN($digits = 5){ $i = 0; //counter
...
<select class="select-single-no-search" name="status">
<option selected disabled>--Select--</option>
<option value="0">Deactive</option>
<option value="1">Active</option>
</select>
</div>
<input type="submit" name="addcat" value="Add Category" class="btn btn-primary btn-outline-light">
