...
<div class="col-6 col-md-2 d-flex align-items-center text-alternate text-medium text-muted text-small">Customer Name</div>
<div class="col-6 col-md-2 d-flex align-items-center text-alternate text-medium text-muted text-small">Address</div>
<div class="col-6 col-md-1 d-flex align-items-center text-alternate text-medium text-muted text-small">Payment Type</div>
<div class="col-6 col-md-2 d-flex align-items-center text-alternate text-medium text-muted text-small">Payment Status</div>
<div class="col-6 col-md-2 d-flex align-items-center text-alternate text-medium text-muted text-small">Order Status</div>
<div class="col-6 col-md-1 d-flex align-items-center text-alternate text-medium text-muted text-small">added_on</div>
<div class="col-6 col-md-1 d-flex align-items-center text-alternate text-medium text-muted text-small">Total</div>
...
$fetch_orders = "SELECT * FROM orders JOIN customer ON orders.user_id = customer.c_id JOIN order_status ON orders.order_status = order_status.id";
...
<a href="orders_details.php?order_id=<?php echo $data['order_id']?>" class="text-truncate h-100 d-flex align-items-center"><?php echo $data['order_id']?></a>
</div>
<div class="col-6 col-md-2 d-flex flex-column justify-content-center mb-2 mb-md-0 order-3 order-md-2">
<div class="text-muted text-small d-md-none">Customer Name</div>
<div class="text-alternate"><?php echo $data['c_email']?></div>
</div>
<div class="col-6 col-md-2 d-flex flex-column justify-content-center mb-2 mb-md-0 order-4 order-md-3">
<div class="text-muted text-small d-md-none">Address</div>
<div class="text-alternate">
<span>
<span class="text-small">
<?php echo $data['address']?><br>
<?php echo $data['city']?><br>
<?php echo $data['pincode']?><br>

</span>
</div>
</div>
<div class="col-6 col-md-1 d-flex flex-column justify-content-center mb-2 mb-md-0 order-5 order-md-4">
<div class="text-muted text-small d-md-none">Payment Type</div>
<div class="text-alternate"><?php echo $data['payment_type']?></div>
</div>
<div class="col-6 col-md-2 d-flex flex-column justify-content-center mb-2 mb-md-0 order-5 order-md-4">
<div class="text-muted text-small d-md-none">Payment Status</div>
<div class="text-alternate"><?php echo $data['payment_status']?></div>
</div>
<div class="col-6 col-md-1 d-flex flex-column justify-content-center mb-2 mb-md-0 order-last order-md-5">
<div class="text-muted text-small d-md-none">Order Status</div>
<div class="text-alternate">
<span class="badge rounded-pill bg-outline-primary"><?php echo $data['status']?></span>
</div>
</div>
<div class="col-6 col-md-2 d-flex flex-column justify-content-center mb-2 mb-md-0 order-last order-md-5">
<div class="text-muted text-small d-md-none">Added On</div>
<div class="text-alternate">
<span class="badge rounded-pill bg-outline-primary"><?php echo $data['added_on']?></span>
</div>
</div>
<div class="col-6 col-md-1 d-flex flex-column justify-content-center mb-2 mb-md-0 order-last order-md-5">
<div class="text-muted text-small d-md-none">Total</div>
<div class="text-alternate">
<span class="badge rounded-pill bg-outline-primary"><?php echo $data['total']?></span>
</div>
</div>
