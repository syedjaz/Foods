...
if(isset($_POST['updatebook'])){
    ...
    $update_sql = "UPDATE book_stock SET book = '{$filename}' , book_status = '{$bstatus}' WHERE id = '{$id}'";
 
    }
    else{
        $bstatus = $_POST['bstatus'];
        $update_sql = "UPDATE book_stock SET book_status = '{$bstatus}' WHERE id = '{$id}'";
...
<span class="text-small align-middle">Update Book</span>
</a>
...
<div class="col-xl-12">
<div class="mb-5">
<h2 class="small-title">Book Stock</h2>
<div class="card">
<div class="card-body">
...
<div class="mb-3 w-100">
<input type="submit" name="updatebook" value="Update Book" class="btn btn-primary btn-outline-light">
</div>
</div>
