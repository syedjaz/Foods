...
<a href="addbanner.php"><i data-cs-icon="plus"></i>
...
<?php
    ...
    <div class="card mb-2">
        ...
        <div class="col-12 col-lg-3 d-flex flex-column pe-1 mb-2 mb-lg-0 justify-content-center order-3">
            <div class="lh-1 text-alternate"><?php echo $data['text1']?></div>
        </div>
        ...
        <div class="col-12 col-lg-1 d-flex flex-column pe-1 mb-2 mb-lg-0 justify-content-center order-4">
        <img src="media/<?php echo $data['banner_img']?>" alt="" width="60" height="60" style="border:1px ridge black">
        </div>
        ...
        <div class="lh-1 text-alternate">
            <a href="banneredit.php?bannerid=<?php echo $data['id']?>"> Edit </a>| <a href="banner_del.php?bannerid=<?php echo $data['id']?>">Delete</a> </div>
        </div>
